...
CREATE TABLE APODERADO (
    IDAPO int NOT NULL AUTO_INCREMENT COMMENT 'contiene los identificadores del apoderado',
...
CREATE TABLE ASISTENCIA (
    IDASI int NOT NULL AUTO_INCREMENT COMMENT 'en este campo es donde se identificara las asistencias',
...
CREATE TABLE CRITERIO_NOTA (
    IDCRINOT int NOT NULL AUTO_INCREMENT COMMENT 'contiene la identificaciones de los criterios de notas',
...
-- Table: CURSO
CREATE TABLE CURSO (
    IDCUR int NOT NULL AUTO_INCREMENT COMMENT 'contiene el identificador de los cursos',
...
CREATE TABLE EMPLEADO (
    IDEMP int NOT NULL AUTO_INCREMENT COMMENT 'contiene los identificadores de los empleados',
...
CREATE TABLE ESTUDIANTE (
    IDEST int NOT NULL AUTO_INCREMENT COMMENT 'contiene el identificador de los estudiantes',
...
CREATE TABLE MATRICULA (
    IDMAT int NOT NULL AUTO_INCREMENT comment 'contiene el identificador de las matriculas',
    FECMAT date COMMENT 'contiene la fecha de inscripción',
...
-- Table: NOTA
CREATE TABLE NOTA (
    IDNOT int NOT NULL AUTO_INCREMENT comment'contiene el identificador de las',
...
-- Table: SALON
CREATE TABLE SALON (
    IDSAL int NOT NULL auto_increment COMMENT 'contiene los identificadores de los salones',
